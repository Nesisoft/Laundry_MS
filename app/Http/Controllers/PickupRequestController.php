...
class PickupRequestController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'status' => 'sometimes|in:pending,accepted,in-progress,completed,cancelled',
        ]);
    ...
    public function toggleArchive(Request $request, $id)
    {
        ...
        try {
            $pickupRequest = PickupRequest::findOrFail($id);
            $pickupRequest->archived = $request->archived;
            $pickupRequest->save();
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $pickupRequest->payments()->delete();
            $pickupRequest->driverAssignments()->delete();
